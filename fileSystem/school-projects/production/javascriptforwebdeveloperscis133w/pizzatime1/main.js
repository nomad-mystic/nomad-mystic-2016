...
var ga_radSize = document.getElementsByName("radSize");
 /*
 Notice that we are NOT using getElementById for the radio buttons -- getElementById doesn't work for radio buttons.  We need to grab the entire group of radio buttons (remember -- the group is an array). The getElementsByName() function allows us to grab the entire array.
...
var ga_chkTopping = document.getElementsByName("chkTopping");
...
function Init() {
	...
	document.getElementById("h1Title").innerHTML = "PizzaTime 1.0";
