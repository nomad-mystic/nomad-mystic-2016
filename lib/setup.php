 ...
 */
function assets() {
      wp_enqueue_style('nomad-css', Assets\asset_path('styles/main.css'), false, null);
//      wp_enqueue_style('nomad-font-awesome', Assets\asset_path('styles/font-awesome.css'), false, null);
