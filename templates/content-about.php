...
<!--                	<img src="http://nomadmystic.com/nomadmystic/wordpress/wp-content/themes/nomadmystic/dist/images/resume.jpg"-->
<!--                         class="img-responsive nomadResume"-->
<!--                         title="Nomad Mystic Resume current as of 5-15-2016"-->
<!--                         alt="Nomad Mystic Resume current as of 5-15-2016">-->
<!--                    <div class="squareButtonPrimaryColor center-block">-->
<!--                        <a href="http://nomadmystic.com/nomadmystic/wordpress/wp-content/themes/nomadmystic/dist/images/resume.pdf" download><span class="fa fa-download"></span>Download Resume</a>-->
<!--                    </div>-->
<!--                </div><!--end col-->
<!--            </div><!--end row-->
<!--        </article>-->
